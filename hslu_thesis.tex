...
with decay factor $\tau_d = 15$ m, ensuring the force diminishes smoothly with distance.
...
where $\gamma_y = 0.15$, $W_{\text{lane}} = 3.5$ m, $\psi_{\text{threshold}} = 0.05$ rad (approximately $\SI{3}{\degree}$), and $\dot{y}_{\text{threshold}} = 0.3$ m/s, all sustained for 5 seconds.
