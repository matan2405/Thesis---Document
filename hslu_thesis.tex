...
%--------------------------------------------------------------
%--------------------------------------------------------------
% CHAPTER 2: MATHEMATICAL MODELING — REVISED V3
% Aligned with codebase commit 36f5b63 (2026-02-15)
%
% CHANGES FROM PREVIOUS VERSION:
%  [C2-1] Bicycle model: rewritten to global-frame kinematic coupling
%         variant with A_c(1,3)=vx, factor-of-2 cornering stiffness.
%         Matches code lateral/vehicle/vehicle.py exactly.
%  [C2-2] Vehicle parameters: updated to Audi TT Coupé values
%         (m=1305, L=2.505, lf=lr=1.2525, etc.)
%  [C2-3] Sampling rates: corrected to 100 Hz sim / 10 Hz long Nash /
%         20 Hz lat Nash. Multi-rate section fully rewritten.
%  [C2-4] Control constraints: a_min = -3.5 (matches Ch4 and code)
%  [C2-5] Stanley controller: rewritten as linear PD with separate
%         k_e and k_psi gains matching code values.
%  [C2-6] Driver personality: Stanley gains updated to code values
%         (0.003/0.005/0.008 for k_e, 0.3/0.5/0.7 for k_psi).
%  [C2-7] Added note on per-tire vs per-axle cornering stiffness.
%--------------------------------------------------------------
